...
function initData (vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"friendshipclub2022","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 102:
/*!******************************************************************!*\
  !*** ./dist/build/mp-weixin/wxcomponents/dist/calendar/utils.js ***!
  \******************************************************************/
...
exports.getUserContest = getUserContest;

// 获取用户参与的比赛列表
function getUserContest() {
  return new Promise(function (resolve, reject) {
    wx.cloud.callFunction({
      name: "getUserContest"
    }).then(function (res) {
...
exports.getContestUser = getContestUser;

// 获取某比赛参与的人的信息
function getContestUser(id) {
  return new Promise(function (resolve, reject) {
    wx.cloud.callFunction({
...
exports.quitContest = quitContest;

// 退出比赛
function quitContest(id) {
  return new Promise(function (resolve, reject) {
    wx.cloud.callFunction({
      name: "quitContest",
      data: {
...
// 设置用户分数
function setCreditScore(score, flag) {
  return new Promise(function (resolve, reject) {
    wx.cloud.callFunction({
      name: "setCreditScore",
      data: {
...
// 计算距离
// 腾讯地图接口
var QQMapWX = __webpack_require__(/*! ../qqMap/qqmap-wx-jssdk.min.js */ 49);
...
/***/ 58:
/*!****************************************!*\
  !*** ./src/api/getUserIntroduction.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getUserIntroduction = getUserIntroduction;

// 修改用户个性签名
function getUserIntroduction(newValue, flag) {
  return new Promise(function (resolve, reject) {
    wx.cloud.callFunction({
      name: "getUserIntroduction",
      data: {
        newValue: newValue,
        flag: flag //true时修改个性签名,false时仅获取
        ...
        if (res.confirm) {
          ...
          uni.getUserProfile({
            ...
            success: function success(res) {
              ...
              uni.getLocation({
                type: "wgs84",
                success: function success(local) {
                  //加入全局变量
                  console.log("个人信息：", res);
                  _vue.default.prototype.userInformation['nickName'] = res.userInfo.nickName;
                  _vue.default.prototype.userInformation['gender'] = res.userInfo.gender;
                  _vue.default.prototype.userInformation['avatarUrl'] = res.userInfo.avatarUrl;
                  ...
                  wx.cloud.callFunction({
                    name: "userLogin",
                    data: _objectSpread({}, _vue.default.prototype.userInformation)
                  }).then(function (res) {
                    resolve(res);
                  }).catch(function (err) {
                    reject(err);
