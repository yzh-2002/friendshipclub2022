...
var _default = {
  ...
  data: function data() {
    return {
      ...
      credit: 0,
      show: false,
      gender: _vue.default.prototype.userInformation["gender"] //啥也不是
  ...
  methods: {
    ...
    reWrite: function reWrite() {
      ...
      (0, _getUserIntroduction.getUserIntroduction)(this.introduction, true).then(function (res) {
        _this.introduction = "" ? undefined : _this.introduction; // 关闭
    ...
    login: function login() {
      ...
      (0, _userLogin.userLogin)().then(function (res) {
        ...
        (0, _getUserIntroduction.getUserIntroduction)("", false).then(function (res) {
          ...
          _this2.introduction = res.result.data[0].introduction == "" ? "这个人还没有个性签名" : res.result.data[0].introduction;
        });
      });
    }
  },
  ...
  created: function created() {
    ...
    if (JSON.stringify(_vue.default.prototype.userInformation) != "{}") {
      ...
      (0, _getUserIntroduction.getUserIntroduction)("", false).then(function (res) {
        ...
        _this3.introduction = res.result.data[0].introduction == "" ? "这个人还没有简介" : res.result.data[0].introduction;
      });
    }
  },
  onShow: function onShow() {
    ...
    console.log(_vue.default.prototype.userInformation); // 每次都要检测是否登录
    ...
    if (JSON.stringify(_vue.default.prototype.userInformation) != "{}") {
      ...
      (0, _getUserIntroduction.getUserIntroduction)("", false).then(function (res) {
        ...
        _this4.introduction = res.result.data[0].introduction == "" ? "这个人还没有简介" : res.result.data[0].introduction;
      });
    }
  }
};
