...
var _default = {
  ...
  methods: {
    ...
    reWrite: function reWrite() {
      ...
      (0, _getUserIntroduction.getUserIntroduction)(this.introduction, true).then(function (res) {
        _this.introduction = _this.introduction == "" ? "这个人还没有个性签名" : _this.introduction;
        console.log("修改成功：", res); // 关闭
  ...
  onShow: function onShow() {
    ...
    (0, _getUserIntroduction.getUserIntroduction)("", false).then(function (res) {
      ...
      _this3.introduction = res.result.data[0].introduction == "" ? "这个人还没有个性签名" : res.result.data[0].introduction;
    });
  }
};
